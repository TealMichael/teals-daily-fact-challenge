...
checks = {
    "version 2.9.3": 'APP_VERSION = "2.10.1.1"' in ENGINE,
    ...
    "fully complete route goes straight to final screen": completed.index("if progress.completed_at is not None:") < completed.index("render_daily_result_summary"),
