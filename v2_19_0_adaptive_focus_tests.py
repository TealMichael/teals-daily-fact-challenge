...
check("v2.19 version", APP_VERSION == "2.19.6")
...
check("student UI declares alternate Focus component", '"tdfc_alt_focus_v2196"' in student_ui and "ALT_FOCUS_COMPONENT" in student_ui)
