...
check("no v2.14.3 SQL migration", not (ROOT / "RUN_THIS_ONCE_IN_SUPABASE_v2_14_3.sql").exists())

assert len(checks) == 18, len(checks)
print(f"v2.14.3 Mystery/nav polish regression: {len(checks)}/{len(checks)} checks passed")
