...
def run():
    checks = {}
    checks["version 2.11.0.1"] = APP_VERSION == "2.11.0.1"
    ...
    warmup = section("render_quick_warmup", "render_daily")
    ...
    report = section("_warmup_report_text", "_warmup_outlook_url")
    ...
    print(f"v2.11.0.1 student Igniter + Outlook cleanup: {len(checks)}/{len(checks)} checks passed")
