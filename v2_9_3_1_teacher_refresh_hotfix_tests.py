...
checks = {
    'version 2.10.0': APP_VERSION == '2.11.0.2',
    ...
    'Today finishes refresh after status read': 'learning_stats = store.class_learning_stats' in today and '_finish_teacher_refresh()' in today and today.index('_finish_teacher_refresh()') > today.index('learning_stats = store.class_learning_stats'),
