...
check("current version", APP_VERSION == "2.19.6")
...
check("alternate student UI declares Fix component", '"tdfc_alt_fix_v2196"' in student_ui and "ALT_FIX_COMPONENT" in student_ui)
