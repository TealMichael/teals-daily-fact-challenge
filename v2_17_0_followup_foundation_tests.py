...
check("current version", APP_VERSION == "2.21.0")
...
check("alternate student UI declares Fix component", '"tdfc_alt_fix_v2197"' in student_ui and "ALT_FIX_COMPONENT" in student_ui)
